...
type Querier interface {
	...
	AddTechnologieSubdomain(ctx context.Context, arg AddTechnologieSubdomainParams) (TechnologieSubdomain, error)
	AddTechnologieVersion(ctx context.Context, arg AddTechnologieVersionParams) (TechnologieVersion, error)
	CountIps(ctx context.Context) (int64, error)
	CountIpsWithProgramID(ctx context.Context, programID int64) (int64, error)
	CountParams(ctx context.Context) (int64, error)
	CountPortsByIp(ctx context.Context, ipID int64) (int64, error)
	...
	CountTechnologies(ctx context.Context) (int64, error)
	CountTechnologiesVersion(ctx context.Context, technologyID int64) (int64, error)
	...
	CreateTechnologie(ctx context.Context, name string) (Technology, error)
	...
	DeleteTechnologieByIDs(ctx context.Context, id int64) error
	...
	FindAllIps(ctx context.Context) ([]Ip, error)
	FindAllPrograms(ctx context.Context) ([]Program, error)
	FindAllSubdomains(ctx context.Context) ([]Subdomain, error)
	FindAllTechnologies(ctx context.Context) ([]Technology, error)
	...
	FindIpByIp(ctx context.Context, ip string) (Ip, error)
	...
	FindPortsWithIpID(ctx context.Context, ipID int64) ([]Port, error)
	FindPortsWithIpIDAndPort(ctx context.Context, arg FindPortsWithIpIDAndPortParams) (Port, error)
	...
	FindSubdomainsBySubdomainAndProgramID(ctx context.Context, arg FindSubdomainsBySubdomainAndProgramIDParams) (Subdomain, error)
	...
	FindTechnologieByIDs(ctx context.Context, id int64) (Technology, error)
	FindTechnologieByName(ctx context.Context, name string) (Technology, error)
	FindTechnologieVersionsByIDs(ctx context.Context, technologyID int64) ([]TechnologieVersion, error)
	FindTechnologiesBySubdomain(ctx context.Context, subdomainID int64) ([]Technology, error)
	...
	UpdateTechnologie(ctx context.Context, arg UpdateTechnologieParams) (Technology, error)
